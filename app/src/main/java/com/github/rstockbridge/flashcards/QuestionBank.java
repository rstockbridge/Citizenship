...
public class QuestionBank {
    ...
    private QuestionBank() {
        ...
        questions.add(new Question("What is the supreme law of the land?", "the Constitution"));
        questions.add(new Question("What does the Constitution do?", "- sets up the government\n" + "- defines the government\n" + "- protects basic rights of Americans"));
        questions.add(new Question("The idea of self-government is in the first three words of the Constitution. What are these words?", "We the People"));
        questions.add(new Question("What is an amendment?", "- a change (to the Constitution)\n" + "- an addition (to the Constitution)"));
        questions.add(new Question("What do we call the first ten amendments to the Constitution?", "the Bill of Rights"));
        questions.add(new Question("What is one right or freedom from the First Amendment?", "- speech\n" + "- religion\n" + "- assembly\n" + "- press\n" + "- petition the government"));
        questions.add(new Question("How many amendments does the Constitution have?", "twenty-seven (27)"));
        ...
        questions.add(new Question("What is freedom of religion?", "You can practice any religion, or not practice a religion."));
        ...
        questions.add(new Question("Who is in charge of the executive branch?", "the President"));
        questions.add(new Question("Who makes federal laws?", "- Congress\n" + "- Senate and House (of Representatives)\n" + "- (U.S. or national) legislature"));
        questions.add(new Question("What are the two parts of the U.S. Congress?", "the Senate and House (of Representatives)"));
        questions.add(new Question("How many U.S. Senators are there?", "one hundred (100)"));
        questions.add(new Question("We elect a U.S. Senator for how many years?", "six (6)"));
        questions.add(new Question("Who is one of your state’s U.S. Senators now?", "- Gary Peters\n" + "- Debbie Stabenow"));
        questions.add(new Question("The House of Representatives has how many voting members?", "four hundred thirty-five (435)"));
        questions.add(new Question("We elect a U.S. Representative for how many years?", "two (2)"));
        questions.add(new Question("Name your U.S. Representative.", "David Trott"));
        questions.add(new Question("Who does a U.S. Senator represent?", "all people of the state"));
        ...
        questions.add(new Question("We elect a President for how many years?", "four (4)"));
        questions.add(new Question("In what month do we vote for President?", "November"));
        ...
        questions.add(new Question("If the President can no longer serve, who becomes President?", "the Vice President"));
        questions.add(new Question("If both the President and the Vice President can no longer serve, who becomes President?", "the Speaker of the House"));
        questions.add(new Question("Who is the Commander in Chief of the military?", "the President"));
        questions.add(new Question("Who signs bills to become laws?", "the President"));
        questions.add(new Question("Who vetoes bills?", "the President"));
        questions.add(new Question("What does the President’s Cabinet do?", "advises the President"));
        ...
        questions.add(new Question("What is the highest court in the United States?", "the Supreme Court"));
        questions.add(new Question("How many justices are on the Supreme Court?", "nine (9)"));
        questions.add(new Question("Who is the Chief Justice of the United States now?", "John Roberts (John G. Roberts, Jr.)"));
        ...
        questions.add(new Question("Who is the Governor of your state now?", "Rick Snyder"));
        questions.add(new Question("What is the capital of your state?", "Lansing"));
        questions.add(new Question("What are the two major political parties in the United States?", "Democratic and Republican\n"));
        questions.add(new Question("What is the political party of the President now?", "Republican (Party)"));
        ...
        questions.add(new Question("How old do citizens have to be to vote for President?", "eighteen (18) and older"));
        ...
        questions.add(new Question("When is the last day you can send in federal income tax forms?", "April 15"));
        ...
        questions.add(new Question("Who wrote the Declaration of Independence?", "(Thomas) Jefferson"));
        questions.add(new Question("When was the Declaration of Independence adopted?", "July 4, 1776"));
        ...
        questions.add(new Question("When was the Constitution written?", "1787"));
        ...
        questions.add(new Question("Who is the “Father of Our Country”?", "(George) Washington"));
        questions.add(new Question("Who was the first President?", "(George) Washington"));
        ...
        questions.add(new Question("What major event happened on September 11, 2001, in the United States?", "Terrorists attacked the United States."));
        ...
        questions.add(new Question("What ocean is on the West Coast of the United States?", "Pacific (Ocean)"));
        questions.add(new Question("What ocean is on the East Coast of the United States?", "Atlantic (Ocean)"));
        ...
        questions.add(new Question("What is the capital of the United States?", "Washington, D.C."));
        ...
        questions.add(new Question("What is the name of the national anthem?", "The Star-Spangled Banner"));
        questions.add(new Question("When do we celebrate Independence Day?", "July 4"));
